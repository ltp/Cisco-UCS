...
Note that you are not supposed to call the constructor yourself, rather a Cisco::UCS::Chassis
is created automatically via calls to a L<Cisco::UCS> object like I<get_chassis> or I<chassis>.
...
Returns a L<Cisco::UCS::Blade> object for the blade identified by the given slot ID.  This method
takes a single mandatory argument - an integer value specifying the slot ID of the desired blade.
...
=head3 get_blade ( $id )
  ...
  print "Blade " . $blade->id . " thermal is " . $blade->thermal ", power is " . $blade->power . "\n";

Returns a L<Cisco::UCS::Blade> object for the specified blade identified by the given slot ID.
...
Returns a L<Cisco::UCS::FEX> object for the blade identified by the given slot ID.  This method
takes a single mandatory argument - an integer value specifying the slot ID of the desired FEX.
...
Returns a L<Cisco::UCS::FEX> object for the FEX identified by the given slot ID.  
...
Returns a L<Cisco::UCS::Common::FanModule> object for the specified fan module.  Note that 
...
Returns a L<Cisco::UCS::Common::FanModule> object for the specified fan module in the designated chassis.
...
Please report any bugs or feature requests to C<bug-cisco-ucs-chassis at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Cisco-UCS-Chassis>.  I will be notified, and then you'll
