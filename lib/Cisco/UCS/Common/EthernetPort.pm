...
sub new {
        ...
        my %attr = %{$self->{ucs}->resolve_dn(dn => $self->{dn})->{outConfig}->{etherPIo}};
...
sub _get_stats {
	...
	my %stats = %{($self->{ucs}->resolve_dn(dn => "$self->{dn}/$type-stats"))->{outConfig}->{$class}};
...
=head1 SYNOPSIS
    ...
    print "FI A port 1/2 operational_speed is " . $ucs->interconnect(A)->card(1)->eth_port(2)->oper_speed;
    print ', total bytes transmitted is ", $ucs->interconnect(A)->card(1)->eth_port(1)->tx_total_bytes, ".\n";
...
Cisco::UCS::Common::EthernetPort is a class used to represent a single Ethernet port in a L<Cisco::UCS>
...
objects are created for you automatically via methods in other L<Cisco::UCS> packages like the i<get_ports>
method in L<Cisco::UCS::Interconnect>.
...
The numeric id of the chassis to which this port is connected.  This value will be blank for port 
that are configured as network uplinks.
...
The statistics methods listed below allow retrieval of interface counter statistical data.  These 
methods fall into three broad categories; transmit (I<tx>), receive (I<rx>) and error (I<err>).
...
Where B<type> is one of rx, tx or err as described in the B<STATISTICS METHODS> section above, and
B<counter_name> is the name of the counter as per the section below.
...
Caching methods are named using the same form as non-caching methods excluding the prefix B<get_>.
...
Transmit, receive and error counter data share the following common methods that are a function of 
...
The methods listed below are common to transmit and receive methods with the implied understanding 
that transmit refers to counter values for data out and receive refers to counter data for traffic in.
...
Returns the delta value of the number of transmitted or received broadcast packets for the specified interface
...
Returns the average delta value of the number of transmitted or received broadcast packets for the specified interface
between the current and previous collection period.
...
Returns the minimum delta value of the number of transmitted or received broadcast packets for the specified interface
between the current and previous collection period.
...
Returns the maximum delta value of the number of transmitted or received broadcast packets for the specified interface
between the current and previous collection period.
...
Returns the delta value of the number of transmitted or received jumbo packets for the specified interface between the current and previous 
collection period.
...
Returns the average delta value of the number of transmitted or received jumbo packets for the specified interface between the current and 
...
Returns the minimum delta value of the number of transmitted or received jumbo packets for the specified interface between the current and 
previous collection period.
...
Returns the maximum delta value of the number of transmitted or received jumbo packets for the specified interface between the current and 
previous collection period.
...
Returns the delta value of the number of transmitted or received multicast packets for the specified interface between the current and 
previous collection period.
...
Returns the average delta value of the number of transmitted or received multicast packets for the specified interface
between the current and previous collection period.
...
Returns the minimum delta value of the number of transmitted or received multicast packets for the specified interface
between the current and previous collection period.
...
Returns the maximum delta value of the number of transmitted or received multicast packets for the specified interface
between the current and previous collection period.
...
Returns the delta value of the number of transmitted or received bytes for the specified interface between the current and previous 
collection period.

=head2 get_tx_total_bytes_delta_avg get_rx_total_bytes_delta_avg rx_total_bytes_delta_avg tx_total_bytes_delta_avg 

Returns the average delta value of the number of transmitted or received bytes for the specified interface between the current and 
previous collection period.

=head2 get_tx_total_bytes_delta_min get_rx_total_bytes_delta_min rx_total_bytes_delta_min tx_total_bytes_delta_min 

Returns the minimum delta value of the number of transmitted or received bytes for the specified interface between the current and 
previous collection period.

=head2 get_tx_total_bytes_delta_max get_rx_total_bytes_delta_max rx_total_bytes_delta_max tx_total_bytes_delta_max 

Returns the maximum delta value of the number of transmitted or received bytes for the specified interface between the current and 
previous collection period.
...
Returns the delta value of the number of transmitted or received packets for the specified interface between the current and previous 
collection period.
...
Returns the average delta value of the number of transmitted or received packets for the specified interface between the current 
and previous collection period.
...
Returns the minimum delta value of the number of transmitted or received packets for the specified interface between the current 
and previous collection period.
...
Returns the maximum delta value of the number of transmitted or received packets for the specified interface between the current 
and previous collection period.
...
Returns the delta value of the number of transmitted or received unicast packets for the specified interface between the current 
and previous collection period.
...
Returns the average delta value of the number of transmitted or received unicast packets for the specified interface
between the current and previous collection period.
...
Returns the minimum delta value of the number of transmitted or received unicast packets for the specified interface
between the current and previous collection period.
...
Returns the maximum delta value of the number of transmitted or received unicast packets for the specified interface
between the current and previous collection period.
...
Returns the delta value of the number of alignment errors for the specified interface between the current and previous
collection period.
...
Returns the minimum delta value of the number of alignment errors for the specified interface between the current and previous
collection period.

=head2 get_err_align_delta_max err_align_delta_max 

Returns the maximum delta value of the number of alignment errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of deferrment errors for the specified interface between the current and previous
collection period.

=head2 get_err_deferred_tx_delta_avg err_deferred_tx_delta_avg 

Returns the average delta value of the number of deferrment errors for the specified interface between the current and previous
collection period.

=head2 get_err_deferred_tx_delta_min err_deferred_tx_delta_min 

Returns the minimum delta value of the number of deferrment errors for the specified interface between the current and previous
collection period.

=head2 get_err_deferred_tx_delta_max err_deferred_tx_delta_max 

Returns the maximum delta value of the number of deferrment errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of frame check sequence errors for the specified interface between the current and previous
collection period.

=head2 get_err_fcs_delta_avg err_fcs_delta_avg 

Returns the average delta value of the number of frame check sequence errors for the specified interface between the current and previous
collection period.

=head2 get_err_fcs_delta_min err_fcs_delta_min 

Returns the minimum delta value of the number of frame check sequence errors for the specified interface between the current and previous
collection period.

=head2 get_err_fcs_delta_max err_fcs_delta_max 

Returns the maximum delta value of the number of frame check sequence errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of interface MAC transmit errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_tx_delta_avg err_int_mac_tx_delta_avg 

Returns the average delta value of the number of interface MAC transmit errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_tx_delta_min err_int_mac_tx_delta_min 

Returns the minimum delta value of the number of interface MAC transmit errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_tx_delta_max err_int_mac_tx_delta_max 

Returns the maximum delta value of the number of interface MAC transmit errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of interface MAC receive errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_rx_delta_avg err_int_mac_rx_delta_avg 

Returns the average delta value of the number of interface MAC receive errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_rx_delta_min err_int_mac_rx_delta_min 

Returns the minimum delta value of the number of interface MAC receive errors for the specified interface between the current and previous
collection period.

=head2 get_err_int_mac_rx_delta_max err_int_mac_rx_delta_max 

Returns the maximum delta value of the number of interface MAC receive errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of out-discard errors for the specified interface between the current and previous
collection period.

=head2 get_err_out_discard_delta_avg err_out_discard_delta_avg 

Returns the average delta value of the number of out-discard errors for the specified interface between the current and previous
collection period.

=head2 get_err_out_discard_delta_min err_out_discard_delta_min 

Returns the minimum delta value of the number of out-discard errors for the specified interface between the current and previous
collection period.

=head2 get_err_out_discard_delta_max err_out_discard_delta_max 

Returns the maximum delta value of the number of out-discard errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of rcv-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_rcv_delta_avg err_rcv_delta_avg 

Returns the average delta value of the number of rcv-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_rcv_delta_min err_rcv_delta_min 

Returns the minimum delta value of the number of rcv-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_rcv_delta_max err_rcv_delta_max 

Returns the maximum delta value of the number of rcv-err errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of undersize errors for the specified interface between the current and previous
collection period.

=head2 get_err_undersize_delta_avg err_undersize_delta_avg 

Returns the average delta value of the number of undersize errors for the specified interface between the current and previous
collection period.

=head2 get_err_undersize_delta_min err_undersize_delta_min 

Returns the minimum delta value of the number of undersize errors for the specified interface between the current and previous
collection period.

=head2 get_err_undersize_delta_max err_undersize_delta_max 

Returns the maximum delta value of the number of undersize errors for the specified interface between the current and previous
collection period.
...
Returns the delta value of the number of xmit-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_xmit_delta_avg err_xmit_delta_avg 

Returns the average delta value of the number of xmit-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_xmit_delta_min err_xmit_delta_min 

Returns the minimum delta value of the number of xmit-err errors for the specified interface between the current and previous
collection period.

=head2 get_err_xmit_delta_max err_xmit_delta_max 

Returns the maximum delta value of the number of xmit-err errors for the specified interface between the current and previous
collection period.
